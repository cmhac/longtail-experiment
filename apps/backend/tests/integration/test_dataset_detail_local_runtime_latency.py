"""Integration tests for repeated local detail request latency envelope."""
...
def test_dataset_detail_repeated_request_latency_envelope() -> None:
    ...
    assert len(samples) == _REPETITIONS
