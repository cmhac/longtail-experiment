  ...
  return (
    ...
    >
      <div className="shell-footer-content" data-testid="footer-content-container">
        <div className="mx-auto grid w-[min(100%,74rem)] gap-[0.55rem] px-[1.2rem] pt-[1.5rem] pb-[1.8rem] max-[720px]:px-4 max-[720px]:pt-[1.25rem] max-[720px]:pb-[1.45rem]">
          <p className="shell-footer-brand" data-testid="footer-brand">
            <span className="m-0 font-bold font-serif text-[1.15rem] text-[var(--shell-foreground)] leading-[1.3] max-[720px]:text-[1.05rem]">
              {FOOTER_CONTENT.brandText}
            </span>
          </p>
          <p className="shell-footer-mission" data-testid="footer-mission">
            <span className="m-0 max-w-[58ch] text-(--shell-muted) text-[0.92rem] leading-[1.55] [text-wrap:pretty] max-[720px]:max-w-none max-[720px]:text-[0.9rem]">
